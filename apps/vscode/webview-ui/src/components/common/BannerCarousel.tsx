				...
				{banners.length > 1 && (
					<div className="flex justify-between items-center px-3 py-1.5 border-t border-description/15">
						...
						<div className="flex gap-0.5">
							<Button aria-label="Banner anterior" onClick={handlePrevious} size="icon" variant="icon">
								<ChevronLeft className="size-4" />
							</Button>
							<Button aria-label="Banner siguiente" onClick={handleNext} size="icon" variant="icon">
