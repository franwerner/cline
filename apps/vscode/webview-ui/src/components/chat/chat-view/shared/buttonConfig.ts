...
export const BUTTON_CONFIGS: Record<string, ButtonConfig> = {
	...
	api_req_failed: {
		...
		secondaryText: "Iniciar nueva tarea",
		primaryAction: "retry",
	...
	mistake_limit_reached: {
		...
		enableButtons: true,
		primaryText: "Continuar de todos modos",
		secondaryText: "Iniciar nueva tarea",
	...
	command_output: {
		sendingDisabled: false,
		enableButtons: true,
		primaryText: "Continuar mientras se ejecuta",
	...
	completion_result: {
		sendingDisabled: false,
		enableButtons: true,
		primaryText: "Iniciar nueva tarea",
		secondaryText: undefined,
	...
	new_task: {
		sendingDisabled: false,
		enableButtons: true,
		primaryText: "Iniciar nueva tarea con contexto",
		secondaryText: undefined,
		primaryAction: "new_task",
		secondaryAction: undefined,
	},
	...
	condense: {
		sendingDisabled: false,
		enableButtons: true,
		primaryText: "Condensar conversación",
		secondaryText: undefined,
	...
	report_bug: {
		sendingDisabled: false,
		enableButtons: true,
		primaryText: "Crear incidencia de GitHub",
		secondaryText: undefined,
		primaryAction: "utility",
		secondaryAction: undefined,
	},
